...
class SiaisGincGlosasCargue extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('siais_ginc_glosas_cargue', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('siais_ginc_glosas_cargue');
    }
}
